...
class CustomResUsers(models.Model):
    ...
    def users_authentic(self):
        ...
        url = google_auth_endpt + 'scope=https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/calendar.events&access_type=' + access_type + '&include_granted_scopes=true&response_type=code&redirect_uri=' + redirect_uri + '&client_id=' + client_id
        # print("@@@@@@@@@@@@URL@@@@@@@@@@@@",url)
        return {
